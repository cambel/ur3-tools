...
def go_to():
    ...
    #peg in hole
    # goal (x,y,z) 0.250, 0.300, 0.157 Quaternion [-0.633, 0.340, -0.338, 0.607]
    q = np.deg2rad([33.47, -47.82, 101.88, -142.03, -90.85, 0.80])
...
def place_models():
    ...
    objpose = [[-0.381961, -0.250909, 0.816082], None]
